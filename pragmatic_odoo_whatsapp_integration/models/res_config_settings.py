...
class base(models.TransientModel):
    ...
    group_order_info_msg = fields.Boolean("Add Order information in message?",implied_group='pragmatic_odoo_whatsapp_integration.group_order_info_msg')
    ...
    group_purchase_order_info_msg = fields.Boolean("Add Order information in message?", implied_group='pragmatic_odoo_whatsapp_integration.group_purchase_order_info_msg')
    ...
    group_stock_info_msg = fields.Boolean("Add order information in message?", implied_group='pragmatic_odoo_whatsapp_integration.group_stock_info_msg')
    ...
    group_invoice_info_msg = fields.Boolean("Add order information in message?", implied_group='pragmatic_odoo_whatsapp_integration.group_invoice_info_msg')
    ...
    def get_values(self):
        ...
        # print("\n\n999999999999999999999999: ",Param.sudo().get_param('pragmatic_odoo_whatsapp_integration.payment_remainder_date'))
        # if not Param.sudo().get_param('pragmatic_odoo_whatsapp_integration.payment_remainder_date'):
        #     print("\n\nIn if not--------------")
        #     self.env['ir.config_parameter'].sudo().set_param('pragmatic_odoo_whatsapp_integration.payment_remainder_date', fields.Date.today())
