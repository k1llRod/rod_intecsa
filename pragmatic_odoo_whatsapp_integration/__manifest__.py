{
    ...
    'summary': 'whatsapp connector whatsapp integration odoo  Whatsapp task Whatsapp sale order Whatsapp purchase order Whatsapp invoice Whatsapp payment reminder Whatsapp pos Whatsapp so Whatsapp point of sale whats app communication',
    'description': """
...
Point of sale, Purchase orders, Payment Reminder, User signup page via the same application. 
...
------------------------------------------------
    ...
    * Send message when a user signs up on the Odoo website page.
    ...
    """,
    'depends': ['contacts', 'base_setup', 'delivery', 'sale', 'stock', 'sale_management', 'account', 'purchase_stock'],
    'data': [
