...
class Download_xls(http.Controller):
    ...
    def download_document(self,model,id, **kw):
        ...
        if res.img_for == 'employee':
            ...
            employee_zip = request.env['ir.attachment'].search([('name','=','employee.zip')])
            ...
            partner_zip = request.env['ir.attachment'].search([('name','=','partner.zip')])
            ...
            product_zip = request.env['ir.attachment'].search([('name','=','product.zip')])
