...
class SaleOrderLine(models.Model):
	...
	is_warehouse = fields.Boolean(default=lambda x: x.env['ir.config_parameter'].sudo().get_param('sale_order_line_by_warehouse_app.allow_warehouse'))
	...
	def _action_launch_stock_rule(self, previous_product_uom_qty=False):
		...
		"""
		allow_warehouse = self.env['ir.config_parameter'].sudo().get_param('sale_order_line_by_warehouse_app.allow_warehouse')
