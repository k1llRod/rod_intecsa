...
class crm_lead(models.Model):
    ...
    check_list_history_ids = fields.One2many("crm.check.history", "lead_id", string="History")
    check_list_len = fields.Integer(string= "Total points", compute= _compute_check_list_len, store= True)
    checklist_progress = fields.Float(string="Progress", compute=_compute_check_list_len, store=True)
