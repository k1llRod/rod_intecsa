...
class AccountMove(models.Model):
    ...
    vr_attachment_qr = fields.Many2one(
        comodel_name='ir.attachment',
        string='QR Link SIAT',
        help='QR con el link de la factura en SIAT.',
        copy=False,
    )

    vr_fecha_emision = fields.Char(
    ...
    vr_leyenda_rep_graf = fields.Text(
        string='Leyenda rep. Gráfica',
        copy=False,
    )
