odoo.define('rp_hide_action_form_v12.hide_action_form_optn', function (require) {
    "use strict";
    ...
    FormController.include({
        ...
        willStart: function () {
            ...
            var def1 = this.getSession().user_has_group('rp_hide_action_form_v12.group_archive_access').then(function (has_archive_group) {
                self.has_archive_group = has_archive_group;
            });
            var def2 = this.getSession().user_has_group('rp_hide_action_form_v12.group_delete_access').then(function (has_delete_group) {
                self.has_delete_group = has_delete_group;
            });
            var def3 = this.getSession().user_has_group('rp_hide_action_form_v12.group_duplicate_access').then(function (has_duplicate_group) {
