...
# =====================================================================================
{
    ...
    'summary': 'Pack of modules to Send WhatsApp message from many places with Templates (Sale, Invoice, Purchase, CRM Leads, Product, Stock Picking, Partner). apichat.io GupShup Chat-Api ChatApi. ChatRoom 2.0.',
    'description': 'Send WhatsApp message from many places with Templates (Sale, Invoice, Purchase, CRM Leads, Product, Stock Picking, Partner). All in one screen. ChatRoom 2.0.',
    'version': '0.2',
    'author': 'AcruxLab',
