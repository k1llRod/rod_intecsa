...
class SalesOrder(models.Model):
    ...
    delivery_status = fields.Selection(selection=[
        ('nothing', 'Nada a entregar'), ('to_deliver', 'Para entregar'),
        ('partial', 'Parcialmente'), ('delivered', 'Entregado'),
        ('processing', 'Procesando')
    ], string='Estado de la entrega', compute='_compute_delivery_status', store=True,
