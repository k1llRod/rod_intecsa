...
class inherit_sale(models.Model):
	...
	is_partially_delivery = fields.Boolean(string="Parcialmente Entregado",readonly=1,copy=False)
	is_fully_delivery = fields.Boolean(string="Entregado",readonly=1,copy=False)
	is_partially_paid = fields.Boolean(string="Parcialmente Pagado",readonly=1,copy=False)
	is_fully_paid = fields.Boolean(string="Pagado",readonly=1,copy=False)
