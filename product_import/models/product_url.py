...
class ProductImage(models.Model):
    ...
    lex_product_url = fields.Char(string='Link Producto')
    lex_iframe = fields.Html(sanitize = False, compute = 'get_html')

    #def get_html (self):
    #    for record in self:
    #        record.lex_iframe = f '<iframe src = "record.lex_product_url"/>'
