...
class Website(models.Model):
    ...
    def get_shop_products(self, search=False, category=False, attrib_values=False):
        ...
        query_attrb = '''select product_attribute_value_id,count(DISTINCT product_tmpl_id) as count from product_template_attribute_value where product_tmpl_id in %s group by product_attribute_value_id'''%temp_ids_data
