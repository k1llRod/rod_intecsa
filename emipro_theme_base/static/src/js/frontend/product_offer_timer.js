    	...
    	*/
            ...
            if(end_date != parseInt($(".end_date").val())) {
                if(combination.is_offer && combination.current_date !== 'undefined') {
                    var append_date = "<div class='timer_input'><input type='hidden' class='current_date' value="+ current_date+"></input><input type='hidden' class='start_date' value="+ start_date +"></input><input type='hidden' class='end_date' value="+ end_date +"></input><h6 class='te_offer_timer_prod'>"+msg+"</p></div>"
            ...
            if(combination.has_discounted_price) {
                 ...
                 $(".js_product .te_discount .te_percentage").html("("+discount+"% off)");
                 }
            }
            setTimeout(function () {
