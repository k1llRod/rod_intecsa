...
class SaleOrder(models.Model):
    ...
    vr_validez = fields.Char(string='Validez')
    vr_garantia = fields.Char(string='Garantía')
    vr_entrega = fields.Char(string='Entrega')
    vr_fpago = fields.Char(string='Forma de pago')
